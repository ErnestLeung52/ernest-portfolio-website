...
const Projects = (props: Props) => {
	...
	return (
		...
		>
			<h3 className='absolute top-24 ml-6 uppercase tracking-[20px] text-gray-500 text-2xl'>Projects</h3>

			<div className='mt-2 sm:mt-8 relative w-full flex'>
											...
											<Tab
												...
												className={({ selected }) =>
													classNames(
														...
														'whitespace-nowrap border-b-[3px] py-3 text-xs sm:text-sm md:text-md lg:text-lg font-medium transition-all'
													)
												}
											>
												{project.name}
										...
										{project.features.map((feature) => (
											...
											>
												<div className='mt-6 lg:col-span-5 lg:mt-0'>
													...
													<div className='mt-2 text-xs sm:text-sm md:text-md text-gray-400 lg:text-base transition-all'>
												...
												<div className='lg:col-span-7'>
													...
													<div className='w-[300px] mx-auto overflow-hidden rounded-lg sm:w-[340px] lg:w-[500px] '>
														<img
